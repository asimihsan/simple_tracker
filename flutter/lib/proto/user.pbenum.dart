...
class CreateUserErrorReason extends $pb.ProtobufEnum {
  static const CreateUserErrorReason USER_ALREADY_EXISTS = CreateUserErrorReason._(0, 'USER_ALREADY_EXISTS');
  static const CreateUserErrorReason INTERNAL_SERVER_ERROR = CreateUserErrorReason._(1, 'INTERNAL_SERVER_ERROR');
