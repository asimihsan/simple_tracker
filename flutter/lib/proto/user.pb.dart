...
class CreateUserResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('CreateUserResponse', package: const $pb.PackageName('simpletracker'), createEmptyInstance: create)
    ..aOB(1, 'success')
    ..e<CreateUserErrorReason>(2, 'errorReason', $pb.PbFieldType.OE, defaultOrMaker: CreateUserErrorReason.USER_ALREADY_EXISTS, valueOf: CreateUserErrorReason.valueOf, enumValues: CreateUserErrorReason.values)
    ..hasRequiredFields = false
  ;
